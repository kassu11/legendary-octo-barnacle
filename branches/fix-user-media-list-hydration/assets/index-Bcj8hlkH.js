...
}`,gg=be`query ($page: Int, $id: Int, $type: LikeableType) {
...
}`,mg=be`query media($id: Int, $page: Int) {
  Media(id: $id) {
    id
    title {
      userPreferred
...
}`,Dc=e=>`https://api.animethemes.moe/anime?filter[has]=resources&filter[site]=AniList&filter[external_id]=${e}&include=animethemes.animethemeentries.videos.audio,animethemes.song.artists`,vg=e=>`https://api.animethemes.moe/anime?filter[has]=resources&filter[site]=MyAnimeList&filter[external_id]=${e}&include=animethemes.animethemeentries.videos.audio,animethemes.song.artists`,$g=e=>`https://api.animethemes.moe/artist/${e}?include=songs.animethemes.anime,songs.animethemes.animethemeentries.videos.audio,songs.animethemes.song.artists,resources,images`,Rc=e=>`https://api.jikan.moe/v4/anime/${e}/full`,Nc=e=>`https://api.jikan.moe/v4/manga/${e}/full`,Oc=e=>`https://api.jikan.moe/v4/anime/${e}/characters`,Fc=e=>`https://api.jikan.moe/v4/manga/${e}/characters`,_g=e=>`https://api.jikan.moe/v4/characters/${e}/full`,Uc=e=>`https://api.jikan.moe/v4/anime/${e}/staff`,bg=(e,t)=>`https://api.jikan.moe/v4/${e}?${t}`,yg=(e,t)=>`https://api.jikan.moe/v4/seasons/${e}?${t}`,wg=e=>`https://api.jikan.moe/v4/genres/${e}`,kg=be`query ($id: Int, $page: Int) {
...
}`,Cg=Bc("anime"),xg=Bc("manga"),Vc=e=>be`query ($name: String) {
  User(name: $name) {
    id
    name
    statistics {
...
}`,Ag=Vc("manga"),Tg=Vc("anime"),Gc=e=>be`query ($name: String) {
  User(name: $name) {
    id
    name
    statistics {
...
}`,Ig=Gc("manga"),Eg=Gc("anime"),Lg=be`query ($name: String) {
  User(name: $name) {
    id
    name
    statistics {
...
}`,Mg=Hc("manga"),Dg=Hc("anime"),Rg=e=>be`query ($type: MediaType, $id_in: [Int], $idMal_in: [Int]) {
...
}`,jg=be`mutation ($id: Int, $type: LikeableType) {
...
}`,Wg=be`query ($id: Int, $page: Int, $sort: [MediaSort], $onList: Boolean) {
  Studio(id: $id) {
    id
    name
    isAnimationStudio
...
}`,Xg=be`query{genres:GenreCollection tags:MediaTagCollection{name description category isAdult}}`,Zg=be`query($type:ExternalLinkMediaType){ExternalLinkSourceCollection(mediaType:$type,type:STREAMING){id url site type language color icon}}`,Qg=be`query ($mediaId: Int) {
  Media(id: $mediaId) {
    id
    title {
      userPreferred
...
}`,ef=be`query ($id: Int, $name: String) {
  User(id: $id, name: $name) {
    id
    name
    previousNames {
...
}`,tf=be`query ($id: Int, $type: ActivityType, $page: Int) {
  Page(page: $page, perPage: 25) {
    pageInfo {
      total
      perPage
...
}`;function be(e,...t){const n=[];for(let i=0;i<e.length;i++)n.push(e[i],t[i]||"");const r=/\s*([{}():,\[\]])\s*/g;return n.join("").replace(/\n|\r/g," ").replace(r,"$1").replace(/\s{2,}/g," ")}const sl=["WINTER","SPRING","SUMMER","FALL"],Na=(e=7)=>{const t=new Date;t.setDate(t.getDate()+e);const n=t.getFullYear(),r=rf(t.getMonth());return F(Number.isInteger(e),"Offsetdays is not an integer"),{season:r,seasonYear:n,nextSeason:lr(r,n,1).season,nextYear:lr(r,n,1).year}};function lr(e,t,n=0){F(typeof t=="number","year is not a number"),F(typeof e=="string","season is not a string");const r=n%4,i=Math.trunc(n/4),l=sl.indexOf(e.toUpperCase());return(l+r<0||l+r>3)&&(t+=r/Math.abs(r)),{year:t+i,season:sl[(4+l+r)%4]}}function rf(e){return sl[Math.floor(e/3)]}var ur,hr,ia,St,gr,la,fr,mr,pr,vr,Ut,ol,Wc,cl,qc;const fs=class fs{constructor({start:t,limit:n,interval:r=60,fillAmount:i=1,pool:l,defaultDelay:s=30}){st(this,Ut);st(this,ur,[]);st(this,hr,null);st(this,ia,null);st(this,St);st(this,gr);st(this,la);st(this,fr);st(this,mr);st(this,pr);st(this,vr,Promise.resolve());ot(this,St,t),ot(this,gr,n),ot(this,la,r),ot(this,fr,i),ot(this,pr,s),ot(this,mr,l),It(this,Ut,ol).call(this)}requestToken(){return Ie(this,St)>0?(bi(this,St)._--,!0):!1}enqueue(t){return ot(this,vr,Ie(this,vr).then(t).catch(n=>{console.error("Request error:",n)})),Ie(this,vr)}getDefaultDelay(){return Ie(this,pr)}getsNextToken(){const{promise:t,resolve:n}=Promise.withResolvers();return this.addToBucket(n),t}addToBucket(t){Ie(this,ur).push(t)}delayBucket(t){It(this,Ut,Wc).call(this,t||Ie(this,pr))}};ur=new WeakMap,hr=new WeakMap,ia=new WeakMap,St=new WeakMap,gr=new WeakMap,la=new WeakMap,fr=new WeakMap,mr=new WeakMap,pr=new WeakMap,vr=new WeakMap,Ut=new WeakSet,ol=function(){clearInterval(Ie(this,hr)),ot(this,hr,setInterval(()=>It(this,Ut,cl).call(this),Ie(this,la)*1e3))},Wc=function(t){ot(this,St,0),clearInterval(Ie(this,hr)),clearTimeout(Ie(this,ia)),ot(this,ia,setTimeout(()=>{It(this,Ut,ol).call(this),It(this,Ut,cl).call(this)},t*1e3))},cl=function(){var n;Ie(this,mr)instanceof fs?ot(this,St,Math.min(Ie(this,St)+Math.min(Ie(this,fr),It(n=Ie(this,mr),Ut,qc).call(n)),Ie(this,gr))):ot(this,St,Math.min(Ie(this,St)+Ie(this,fr),Ie(this,gr)));const t=Ie(this,ur).slice();Ie(this,ur).length=0,t.forEach(r=>r())},qc=function(){return Ie(this,St)>0?bi(this,St)._--:Ie(this,St)};let bn=fs;const Ti=xr,Se=oi({storeName:"results",type:"reload",expiresInSeconds:60*60*24*365}),af=oi({storeName:"results",type:"reload",expiresInSeconds:60*60*7}),ht=oi({storeName:"results",type:"fetch-once",expiresInSeconds:60*60*24*365}),Os=oi({storeName:"results",type:"only-if-cached",expiresInSeconds:60*60*24*365}),Ii={animeThemes:new bn({start:90,limit:90,interval:60,defaultDelay:20}),anilist:new bn({start:5,limit:5,interval:2,defaultDelay:20,pool:new bn({start:60,limit:90,interval:60,fillAmount:60})}),jikan:new bn({start:1,limit:1,interval:1/3,defaultDelay:1,pool:new bn({start:3,limit:3,interval:1.25,pool:new bn({start:60,limit:60,interval:60,fillAmount:60})})})};function Fs(e,t,n){let r=null;const i=t.reduce((l,s)=>(s.active&&(s.key==="season"?r=s.value:l.push(`${s.key}=${s.value}`)),l),[]);return n>1&&i.push(`page=${n}`),r?ae.getJson(yg(r,i.sort().join("&")),l=>(l.data.forEach(s=>{s.titles=s.titles.reduce((o,c)=>(o[c.type]=c.title,o),{})}),l)):ae.getJson(bg(e,i.sort().join("&")),l=>(l.data.forEach(s=>{s.titles=s.titles.reduce((o,c)=>(o[c.type]=c.title,o),{})}),l))}const oe={animeThemes:{themesByAniListId:ht(e=>ae.getJson(Dc(e))),artisBySlug:ht(e=>ae.getJson($g(e)))},myAnimeList:{animeById:ht(e=>ae.getJson(Rc(e),t=>t.data)),mangaById:ht(e=>ae.getJson(Nc(e),t=>t.data)),animeCharactersById:ht(e=>ae.getJson(Oc(e),t=>t.data)),mangaCharactersById:ht(e=>ae.getJson(Fc(e),t=>t.data)),animeStaffById:ht(e=>ae.getJson(Uc(e))),mediaSearch:ht(Fs),mediaSearchCache:Os(Fs),genresAndThemes:ht(e=>ae.getJson(wg(e),t=>{const n=new Set,r=["genres","genres","themes"],i={genres:[],themes:[]};let l=0;return t.data.reduce((s,o)=>n.has(o.mal_id)?s:(o.name<s&&(l=Math.min(l+1,r.length-1)),i[r[l]].push(o),n.add(o.mal_id),o.name),""),i.genres.sort(),{translations:{[e]:Object.fromEntries(t.data.map(s=>[s.name,s.mal_id]))},...i}}))},anilist:{mediaId:Se((e,t)=>ae.authAnilist(t,Ul,{id:e,perPage:6})),rateRecommendation:async(e,t,n,r,i)=>(F(e,"Token is missing"),F(typeof e!="function","This specific api doesnt support signals"),F(t!=null,"Id missing"),F(n!=null,"Rating missing"),F(r!=null,"MediaId missing"),F(i!=null,"MediaRecommendationId missing"),await ae.authAnilist(e,pg,{id:t,rating:n,mediaId:r,mediaRecommendationId:i},s=>s.data.SaveRecommendation).send()),userByName:Se((e,t)=>(F(e,"Name is missing"),ae.authAnilist(t,ef,{name:e},n=>n.data.User))),toggleFollow:async(e,t)=>(F(t,"id is missing"),await ae.authAnilist(e,Og,{id:t},r=>r.data.ToggleFollow).send()),userFollowing:Se((e,t=1,n)=>(F(e,"id is missing"),ae.authAnilist(n,Ug,{id:e,page:t},r=>r.data.Page))),userAnimeStats:Se((e,t)=>ae.authAnilist(t,Cg,{name:e},n=>n.data.User.statistics.anime)),userMangaStats:Se((e,t)=>ae.authAnilist(t,xg,{name:e},n=>n.data.User.statistics.manga)),userAnimeGenres:Se((e,t)=>ae.authAnilist(t,Tg,{name:e},n=>n.data.User.statistics.anime.genres)),userMangaGenres:Se((e,t)=>ae.authAnilist(t,Ag,{name:e},n=>n.data.User.statistics.manga.genres)),userAnimeTags:Se((e,t)=>ae.authAnilist(t,Eg,{name:e},n=>n.data.User.statistics.anime.tags)),userMangaTags:Se((e,t)=>ae.authAnilist(t,Ig,{name:e},n=>n.data.User.statistics.manga.tags)),userAnimeStudios:Se((e,t)=>ae.authAnilist(t,Lg,{name:e},n=>n.data.User.statistics.anime.studios)),userAnimeVoiceActors:Se((e,t)=>ae.authAnilist(t,Pg,{name:e},n=>n.data.User.statistics.anime.voiceActors)),userAnimeStaff:Se((e,t)=>ae.authAnilist(t,Dg,{name:e},n=>n.data.User.statistics.anime.staff)),userMangaStaff:Se((e,t)=>ae.authAnilist(t,Mg,{name:e},n=>n.data.User.statistics.manga.staff)),characterIds:ht((e,t)=>ae.authAnilist(t,Ng(e),{ids:e},n=>Object.values(n.data).map(r=>r.characters).flat())),userFollowers:Se((e,t=1,n)=>(F(e,"id is missing"),ae.authAnilist(n,Fg,{id:e,page:t},r=>r.data.Page))),activityByUserId:Se((e,t)=>(F(e,"Id is missing"),ae.authAnilist(t,tf,{id:e}))),activityById:Se((e,t)=>(F(e,"Id is missing"),ae.authAnilist(t,Sg,{id:e},n=>n.data.Activity))),listOfActivityLikes:ht((e,t)=>(F(e,"Id is missing"),ae.authAnilist(t,gg,{id:e,type:"ACTIVITY"},n=>n.data.Page))),activityRepliesById:Se((e,t,n)=>(F(e,"Id is missing"),ae.authAnilist(n,kg,{id:e,page:t},r=>r.data.Page))),notifications:af((e,t,n=1)=>{switch(t){case"airing":return ae.authAnilist(e,Dn,{page:n,types:["AIRING"]},r=>r.data.Page);case"activity":return ae.authAnilist(e,Dn,{page:n,types:["ACTIVITY_MESSAGE","ACTIVITY_MENTION","ACTIVITY_REPLY","ACTIVITY_LIKE","ACTIVITY_REPLY_LIKE"]},r=>r.data.Page);case"forum":return ae.authAnilist(e,Dn,{page:n,types:["THREAD_COMMENT_REPLY","THREAD_SUBSCRIBED","THREAD_COMMENT_MENTION","THREAD_LIKE","THREAD_COMMENT_LIKE"]},r=>r.data.Page);case"follows":return ae.authAnilist(e,Dn,{page:n,types:["FOLLOWING"]},r=>r.data.Page);case"media":return ae.authAnilist(e,Dn,{page:n,types:["RELATED_MEDIA_ADDITION","MEDIA_DATA_CHANGE","MEDIA_MERGE","MEDIA_DELETION"]},r=>r.data.Page);case"all":default:return ae.authAnilist(e,Dn,{page:n},r=>r.data.Page)}}),searchUsers:ht((e,t,n)=>(F(e,"Search is missing"),ae.authAnilist(n,fg,{search:e,page:t},r=>r.data.Page))),mediaListByUserName:Se((e,t,n)=>(F(e,"Name is missing"),ae.authAnilist(n,ll,{userName:e.toLowerCase(),type:t},r=>r.data.MediaListCollection))),mediaListByUserNameFetchOnce:ht((e,t,n)=>(F(e,"Name is missing"),ae.authAnilist(n,ll,{userName:e.toLowerCase(),type:t},r=>r.data.MediaListCollection))),favouritesByUserId:Se((e,t,n)=>(F(e,"Id is missing"),F(t,"Page is missing"),ae.authAnilist(n,Vg,{id:e,page:t},r=>r.data.User.favourites))),mutateFavourites:async(e,t)=>await ae.authAnilist(e,Bg,t).send(),characterInfoById:Se((e,t)=>ae.authAnilist(t,Rs,{id:e},n=>n.data.Character)),characterMediaById:Se((e,t,n={})=>ae.authAnilist(e,Rs,{...n,page:n.page||1,sort:n.sort||"POPULARITY_DESC",onList:n.onList,withRoles:n.withRoles||!0,id:t},r=>r.data.Character.media)),staffInfoById:Se((e,t)=>ae.authAnilist(t,Ai,{id:e},n=>n.data.Staff)),studioInfoAndMediaById:Se((e,t={},n)=>ae.authAnilist(n,Wg,{...t,page:t.page||1,sort:t.sort||"START_DATE_DESC",onList:t.onList,id:e},r=>r.data.Studio)),staffCharactersById:Se((e,t,n={})=>ae.authAnilist(e,Ai,{...n,characterPage:n.characterPage||1,sort:n.sort||"START_DATE_DESC",onList:n.onList,withCharacterRoles:!0,id:t},r=>r.data.Staff.characterMedia)),staffMediaById:Se((e,t,n,r)=>ae.authAnilist(e,Ai,{...r,staffPage:r.staffPage||1,sort:r.sort||"START_DATE_DESC",onList:r.onList,withStaffRoles:!0,id:t,type:n},i=>i.data.Staff.staffMedia)),genresAndTags:ht(()=>ae.anilist(Xg,{},e=>e.data)),externalSources:ht(e=>ae.anilist(Zg,{type:e||void 0},t=>t.data.ExternalLinkSourceCollection)),characters:Se((e,t=1,n)=>ae.authAnilist(n,jc,{id:e,page:t},r=>r.data.Media)),allMediaStaff:Se((e,t=1,n)=>ae.authAnilist(n,Gg,{id:e,page:t},r=>r.data.Media)),trendingMedia:Se(e=>{const t=Na();return ae.authAnilist(e,qg,{season:t.season,seasonYear:t.seasonYear,nextSeason:t.nextSeason,nextYear:t.nextYear})}),trendingAnime:Se(e=>{const t=Na();return ae.authAnilist(e,Jg,{type:"ANIME",season:t.season,seasonYear:t.seasonYear,nextSeason:t.nextSeason,nextYear:t.nextYear})}),trendingManga:Se(e=>{const t=Na();return ae.authAnilist(e,Kg,{type:"MANGA",season:t.season,seasonYear:t.seasonYear,nextSeason:t.nextSeason,nextYear:t.nextYear})}),mediaListEntry:async(e,t)=>(F(t,"MediaId missing"),F(typeof e!="function","This specific api doesnt support signals"),await ae.authAnilist(e,Qg,{mediaId:t}).send()),getAuthUserData:Se(e=>ae.authAnilist(e,nf,{},t=>t.data.Viewer)),getActivity:Se((e,t,n=1)=>ae.authAnilist(e,zc,{...t,page:n},r=>r.data.Page)),searchMedia:ht((e,t,n,r={})=>{const i=t.reduce((l,s)=>(s.active&&(l[s.key]=s.value),l),{page:n});return Object.entries(r).forEach(([l,s])=>{l==="format"||l==="season"||l==="seasonYear"?i[l]=s:l==="episodeGreater"?i[l]=Math.max(s,i[l]||0):(i[l]&&(i[l]=[s,i[l]].flat()),i[l]??(i[l]=s))}),ae.authAnilist(e,Ns,i,l=>l.data.Page)}),searchMediaCache:Os((e,t,n)=>{const r=t.reduce((i,l)=>(l.active&&(i[l.key]=l.value),i),{page:n});return ae.authAnilist(e,Ns,r,i=>i.data.Page)}),friendsMediaScore:Se((e,t,n)=>ae.authAnilist(e,Yc,{id:t,...n})),mutateMedia:async(e,t)=>(F(e,"Token is missing"),F(typeof e!="function","This specific api doesnt support signals"),F(t,"Variables missing"),F(t.id||t.mediaId,"No mutation id given"),await ae.authAnilist(e,zg,t,r=>r.data.SaveMediaListEntry).send()),deleteMediaListEntry:async(e,t)=>(F(e,"Token is missing"),F(typeof e!="function","This specific api doesnt support signals"),F(t!==void 0,"Variables missing"),await ae.authAnilist(e,Hg,{id:t}).send()),toggleActivityLike:async(e,t)=>(F(e,"Token is missing"),F(t,"Variables missing"),F(typeof e!="function","This specific api doesnt support signals"),F(t.id||t.mediaId,"No mutation id given"),await ae.authAnilist(e,jg,{...t,type:"ACTIVITY"}).send()),toggleFavourite:async(e,t)=>(F(e,"Token is missing"),F(t,"Variables missing"),F(typeof e!="function","This specific api doesnt support signals"),await ae.authAnilist(e,Yg,t).send()),wachingAnime:Se((e,t)=>ae.authAnilist(t,Ds,{userId:e,type:"ANIME",perPage:40})),readingManga:Se((e,t)=>ae.authAnilist(t,Ds,{userId:e,type:"MANGA",perPage:40}))}};var Un,$r,_r,An,Kc,Jc,Xc;const Xr=class Xr{constructor(t,{method:n="POST",headers:r,body:i},l){st(this,An);De(this,"expires");st(this,Un);st(this,$r);st(this,_r);F(t,"Url missing"),F(n,"Method missing"),n==="POST"&&F(i,"Body is missing");const s={"Content-Type":"application/json"};this.url=t,this.method=n,this.headers=r||s,this.body=i,this.fromCache=!0,ot(this,Un,l),this.cacheKey=It(this,An,Kc).call(this)}abort(){var t;(t=Ie(this,$r))==null||t.abort()}async send(){var i;const t=It(this,An,Jc).call(this);ot(this,$r,new AbortController),ot(this,_r,Ie(this,$r).signal);const n=await t.enqueue(async()=>{for(;;){if(Ie(this,_r).aborted)return null;if(document.hidden){const{promise:o,resolve:c}=Promise.withResolvers();document.addEventListener("visibilitychange",c,{once:!0}),await o}if(!t.requestToken()){await Promise.race([t.getsNextToken(),new Promise(o=>Ie(this,_r).addEventListener("abort",o))]);continue}const s=await It(this,An,Xc).call(this);if(s.status===429){console.warn("429 received, backing off...",this.url);const o=parseInt(s.headers.get("Retry-After"))||t.getDefaultDelay();await new Promise(c=>setTimeout(c,o*1e3));continue}if(s.status===500&&this.url.includes("anilist")){console.warn("500 received, the request was probably fine, but anilist has lot of traffic. Resend after 2 seconds"),await new Promise(o=>setTimeout(o,2e3));continue}return s}});if(n==null)return null;if(this.status=n.status,!n.ok)return this.error=!0,this;const r=await n.json();return this.data=((i=Ie(this,Un))==null?void 0:i.call(this,r))||r,this.fromCache=!1,this}static anilist(t,n={},r){return Xr.authAnilist(null,t,n,r)}static authAnilist(t,n,r={},i){F(n.length>10,"Query must be above of length 10");const l={"Content-Type":"application/json"};return t&&(l.Authorization="Bearer "+t),new Xr("https://graphql.anilist.co",{method:"POST",headers:l,body:{query:n,variables:r}},i)}static getJson(t,n){return new Xr(t,{method:"GET",cache:"default",headers:{"Content-Type":"application/json"}},n)}};Un=new WeakMap,$r=new WeakMap,_r=new WeakMap,An=new WeakSet,Kc=function(){let t=`${this.url}-${this.method}`;if(this.body){const n=JSON.stringify(this.body).replaceAll('"',"");t+=n}if(this.headers){const n=JSON.stringify(this.headers).replaceAll('"',"");t+=n}if(Ie(this,Un)){const n=Ie(this,Un).toString().replace(/[\n\t\r ]+/g,"");t+=n}return t},Jc=function(){if(this.url.startsWith("https://graphql.anilist.co"))return Ii.anilist;if(this.url.startsWith("https://api.jikan.moe"))return Ii.jikan;if(this.url.startsWith("https://api.animethemes.moe"))return Ii.animeThemes;F(!1,`Fetch to url "${this.url}" does not have any rate limits`)},Xc=function(){const t={method:this.method,headers:this.headers,body:JSON.stringify(this.body),cache:"default"};return Math.random()>1?(console.log("Error route"),fetch("http://127.0.0.1:3000/api/version",t)):fetch(this.url,t)};let ae=Xr;const Ei=new Map,$a=new Map;function oi(e){return e.storeName??(e.storeName=""),e.fetchOnDebug??(e.fetchOnDebug=!1),e.type??(e.type="default"),F(e.type==="no-store"||Number.isInteger(e.expiresInSeconds),"Give explisite expiration time. 0 if the data never expires"),F(e.type==="no-store"||e.expiresInSeconds>0,"Expiration time should be more than 0"),F(e.type!=="no-store"||!e.storeName,"StoreName is not used because cache type is no-store"),function(n){return(...r)=>{const[i,l]=O(void 0),[s,o]=O(!1),[c,u]=O(!1),[h,f]=O(!0);let g=null;const m=e.type=="default"||e.type=="only-if-cached",y=(Ti==!1||e.fetchOnDebug||e.type=="no-store"||!e.storeName)&&m==!1,v=(k,b)=>{if(typeof k=="function"&&(k=k(Ce(i))),k=structuredClone(k),F(Ce(i)!==null||e.type!=="only-if-cached","Can't mutate null data"),F(typeof k=="object","Data should always be JSON object data"),e.type!=="no-store"&&(Ei.set(g.cacheKey,k),e.storeName)){f(!1);const x=Je.fetchCache();x.onsuccess=w=>{const _=w.target.result,I=Je.store(_,e.storeName,"readwrite",()=>f(!0),()=>f(!0)).put(k);b&&(I.onsuccess=b)}}},$=k=>{k.cacheKey===g.cacheKey&&l(k)},C=k=>{typeof k=="function"&&(k=k(Ce(i))),l(k)},S=async()=>{if(e.type==="only-if-cached")return u(!1),l(null);$a.has(g.cacheKey)||$a.set(g.cacheKey,g.send());const k=await $a.get(g.cacheKey);if($a.delete(g.cacheKey),k!==null){if(e.expiresInSeconds){const b=new Date;k.expires=b.setSeconds(b.getSeconds()+e.expiresInSeconds)}He(()=>{k.error?(o(!0),console.assert(!Ti,"Fetch error, not saving data to cache")):(v(k),$(k)),u(!1)})}};return W(()=>{const k=r.map(x=>typeof x=="function"?x():x);if(k.some(x=>x===void 0))return;g==null||g.abort(),g=n(...k),Ti&&console.log("Fetching",e.type,g.body||g.url),He(()=>{u(!0),o(!1)});const b=Ei.get(g.cacheKey);if(b&&b.expires>new Date)if($({...b,fromCache:!0}),e.type==="fetch-once"){u(!1);return}else y===!1&&u(!1);else if(e.type!=="no-store"&&e.storeName){const x=Je.fetchCache();x.onerror=S,x.onsuccess=w=>{const _=w.target.result,I=Je.store(_,e.storeName,"readonly").get(g.cacheKey);I.onerror=S,I.onsuccess=E=>{if(E.target.result&&(F(E.target.result.expires,"Cache should have a expiration date"),F(E.target.result.data,"Cache should always have data"),E.target.result.expires>new Date)){y==!1&&u(!1);const L={...E.target.result,fromCache:!0};return e.type!=="only-if-cached"&&Ei.set(L.cacheKey,L),$(L)}y==!1&&S()}}}else y==!1&&S();y&&S()}),Object.defineProperties(i,{error:{get:()=>s()},loading:{get:()=>c()},indexedDBClosed:{get:()=>h()}}),Ye(()=>g==null?void 0:g.abort()),[i,{mutate:C,refetch:S,mutateCache:v}]}}}var br,Oa;const or=class or{static store(t,n,r,i,l){const s=t.transaction(n,r);return i?s.onerror=i:s.onerror=console.warn,l&&(s.oncomplete=l),s.objectStore(n)}static fetchCache(t){const n=indexedDB.open("legendary-octo-barnacle-cache",2);return t&&(n.onerror=t),n.onupgradeneeded=r=>{var l,s;const i=r.target.result;switch(r.oldVersion){case 0:It(l=or,br,Oa).call(l,i,"results",{keyPath:"cacheKey"});case 1:It(s=or,br,Oa).call(s,i,"debug",{keyPath:"cacheKey"})}},n}static user(t){const n=indexedDB.open("legendary-octo-barnacle-users",1);return t&&(n.onerror=t),n.onupgradeneeded=r=>{var l;const i=r.target.result;switch(r.oldVersion){case 0:It(l=or,br,Oa).call(l,i,"data")}},n}};br=new WeakSet,Oa=function(t,n,r){t.objectStoreNames.contains(n)||t.createObjectStore(n,r)},st(or,br);let Je=or;const Us=e=>{var t,n;return((n=(t=e.anime)==null?void 0:t[0])==null?void 0:n.animethemes)??[]},lf=({id:e,api:t,type:n})=>{if(n===da)switch(t){case il:return kn(Dc(e),Us);case ja:return kn(vg(e),Us)}};class sf{constructor(t,n,r){F(t,"Missing cacheKey"),F(r,"Don't cache empty data"),F(n,"Expiration date is missing"),this.data=r,this.cacheKey=t,this.expires=Ff(n)}}class sn{constructor(t,n,r){F(t,"CacheKey is missing"),this.cacheKey=t,this.data=n,this.cacheType=r}}const Li={},Qe=e=>Vl({cacheTypeSignal:()=>null,disableNullValues:!1,senderDisabledSignal:()=>!1,fetcherSignal:e}),Sn=(e,t)=>Vl({cacheTypeSignal:e,disableNullValues:!0,senderDisabledSignal:()=>!1,enableDebugLogs:!1,fetcherSignal:t}),Bl=(e,t)=>Vl({cacheTypeSignal:()=>null,disableNullValues:!0,senderDisabledSignal:e,enableDebugLogs:!1,fetcherSignal:t}),Vl=({cacheTypeSignal:e,disableNullValues:t,senderDisabledSignal:n,enableDebugLogs:r,fetcherSignal:i,fetchOnDebug:l})=>{dn(e,"cacheTypeSignal is not a function"),dn(n,"senderDisabledSignal is not a function"),dn(i,"fetcherSignal is not a function");const[s,o,c]=uf(void 0),[u,h]=O(!1),[f,g]=O(!1),[m,y]=O(!0);let v=null,$=null;const C=I=>{if(typeof I=="function"){const{data:E,cacheType:L}=Ce(s)||{};return I(new sn(v.cacheKey,E,L))}return I},S=(I,E)=>{var Y,q;const L=C(I),R=new sf(L.cacheKey,v.settings.expiresInSeconds,structuredClone(L.data));R.cacheKey===v.cacheKey&&c(L);const{type:U,storeName:G}=v.settings;if(U==="no-store"||!G)return;(q=(Y=v.settings).saveToSessionStorage)==null||q.call(Y,R),Li[R.cacheKey]=R,y(!1);const J=Je.fetchCache();J.onsuccess=le=>{const Z=le.target.result,X=Je.store(Z,G,"readwrite",()=>y(!0),()=>y(!0)).put(R);E&&(X.onsuccess=E)}},k=I=>{F(I instanceof sn),I.cacheKey===v.cacheKey&&o(I)},b=I=>{I=C(I),F(I instanceof sn),o(I)},x=(I,E)=>{I=C(I),S(I,E),b(I)},w=async(I,E)=>{if(I!==v)return;if(F(I,"fetcher should not be undefined"),E==="only-if-cached"){He(()=>{t||(o(new sn(I.cacheKey,null)),g(!1))});return}$==null||$.abort();const L=new AbortController;$=L;const R=await Nf(I,L.signal);R===null?I===v&&He(()=>{h(!0),g(!1),!L.signal.aborted&&!t&&o(new sn(I.cacheKey,null))}):He(()=>{const U=new sn(I.cacheKey,R);S(U),k(U),I===v&&g(!1)})},_=N(I=>{const E=i(),L=e()||(E==null?void 0:E.settings.type)||I;if(v!==E)return L;switch(xt(I,"prev","If fetcher is same as currentFetcher why is there no previous cacheType"),I){case"only-if-cached":if(L==="default")return L;case"default":if(L==="fetch-once")return L;case"fetch-once":if(L==="reload"||L==="no-store")return L}return I}),A=N(()=>{const I=i(),E=n();return v!==I?E:!1});return P(()=>{if(A())return;const I=i();if(!I){v=null,o(void 0);return}F(I instanceof jl);const E=_();xt(E,"caheType");const L=xr&&!I.settings.fetchOnDebug&&!l&&E!=="no-store",R=!L&&(E==="fetch-once"||E==="reload"||E==="no-store"),U=I.cacheKey;if(v=I,He(()=>{h(!1),g(!0)}),U in Li){const G=Li[U];if(L||E==="only-if-cached"||E==="fetch-once"||E==="default"){He(()=>{o(new sn(G.cacheKey,G.data,"local")),g(!1)});return}else o(new sn(G.cacheKey,G.data,"local"))}else if(E!=="no-store"&&I.settings.storeName){const G=Je.fetchCache(),J=()=>!R&&w(I,E);G.onerror=J,G.onsuccess=Y=>{const q=Y.target.result,Z=Je.store(q,I.settings.storeName,"readonly").get(U);Z.onerror=J,Z.onsuccess=te=>{const X=te.target.result;if(X&&(F(X.expires,"Cache should have a expiration date"),F(X.data,"Cache should always have data"),X.expires>new Date)){const pe=new sn(U,X.data,"indexedDB");R?k(pe):He(()=>{k(pe),g(!1)});return}J()}}}R&&w(I,E)}),Object.defineProperties(s,{error:{get:()=>u()},loading:{get:()=>f()},indexedDBClosed:{get:()=>m()}}),Ye(()=>$==null?void 0:$.abort()),[s,{mutate:b,refetch:()=>w(Ce(i),Ce(i).settings.type),mutateCache:S,mutateBoth:x}]},Gl=(e,t)=>{const[n,r]=O(localStorage.getItem(e)??t);return[n,l=>{r(s=>{const o=typeof l=="function"?l(s):l;return o==null?localStorage.removeItem(e):localStorage.setItem(e,o),o})}]},of=e=>{if(e==="true")return!0;if(e==="false")return!1},Bs=(e,t)=>{const[n,r]=O(of(localStorage.getItem(e))??t);return[n,l=>{r(s=>{const o=typeof l=="function"?l(s):l;return o==null?localStorage.removeItem(e):localStorage.setItem(e,String(o)),o})}]},cf=e=>{try{return JSON.parse(e)}catch{}},df=(e,t)=>{const[n,r]=O(cf(localStorage.getItem(e))??t);return[n,l=>{r(s=>{const o=typeof l=="function"?l(s):l;return o==null?localStorage.removeItem(e):localStorage.setItem(e,JSON.stringify(o)),o})}]},Hl=(e=!0)=>O(xr===e),Vs=e=>{dn(e);const[t,n]=O();return P(()=>{const r=e();n(r)}),[t,n]},uf=e=>{const[t,n]=O(0);let r=e;return[()=>(t(),r),o=>(r=typeof o=="function"?o(r):o,n(u=>u+1),r),o=>(r=typeof o=="function"?o(r):o,r)]},hf=()=>{He(()=>{Zc(e=>e+1),ed(e=>e+1),Qc(e=>e+1),td(e=>e+1)})};let Mt=null;const gf=e=>{Mt===null?(Mt=[e],e()):Mt.includes(e)||Mt.push(e)},ff=()=>{Mt==null||Mt.shift();const e=Mt==null?void 0:Mt[0];e?e():Mt=null},mf=()=>{setTimeout(()=>Zc(e=>e-1),1e3),setTimeout(()=>Qc(e=>e-1),3e3),setTimeout(()=>ed(e=>e-1),5e3),setTimeout(()=>td(e=>e-1),1e4)},[_C,Zc]=O(0),[bC,Qc]=O(0),[za,ed]=O(0),[yC,td]=O(0),pf=()=>{He(()=>{nd(e=>e+1),rd(e=>e+1),ad(e=>e+1),id(e=>e+1)})};let Dt=null;const vf=e=>{Dt===null?(Dt=[e],e()):Dt.includes(e)||Dt.push(e)},$f=()=>{Dt==null||Dt.shift();const e=Dt==null?void 0:Dt[0];e?e():Dt=null},_f=()=>{setTimeout(()=>nd(e=>e-1),1e3),setTimeout(()=>rd(e=>e-1),2e3),setTimeout(()=>ad(e=>e-1),5e3),setTimeout(()=>id(e=>e-1),1e4)},[ci,nd]=O(0),[bf,rd]=O(0),[wC,ad]=O(0),[kC,id]=O(0),[Gs,yf]=je({}),na=7*24*60*60,tr=24*60*60,dl=new Date/1e3,In=e=>Array.isArray(e);function qt(e,t){if(e){if(In(e))return Object.fromEntries(e.map(n=>[n,!0]))}else return t||null;return{[e]:!0}}function We(e){return In(e)?e:e?[e]:[]}const wf=(...e)=>{const t=[];for(const n of e)t.push(...We(n));return t},Hs=(e,t)=>(e=We(e),e.includes(t)),kf=(e,...t)=>We(e).filter(n=>!t.includes(n)),Ys=(e,t,n)=>(e=We(e),(n===void 0?e.includes(t):n)?e=kf(e,t):e.push(t),e);function sr(e){return new Set(We(e))}function Sf(e){F(In(e),"Not array");const t=new Map;return e.forEach(n=>t.set(n.toLowerCase(),n)),Array.from(t.values())}function jr(e,t){return e===t?!0:typeof e!=typeof t?!1:In(e)?e.length===t.length&&e.every((n,r)=>jr(n,t[r])):!1}function Gt(e){return In(e)?e[0]:e}function ld(e,t,n=0,r=e.length-1){for(;n<=r;){const i=(r+n)/2|0,l=t(e[i],i,e);if(l===0)return i;l<0?r=i-1:n=i+1}return-1}function dr(e,t,n=0,r=e.length-1){let i=null;for(;n<=r;){const s=(r+n)/2|0;if(i=t(e[s],s,e),i===0)return s;i<0?r=s-1:n=s+1}return i===null?0:((r+n)/2|0)==e.length-1?i<0?e.length-1:e.length:i<0?r+1:n-1}const Cf=(e,t,n)=>(dn(t),!In(e)||e.length===0?n:e.find(t)??e[0]??n),xf=(e,t,n)=>!In(e)||e.length===0?n:e.at(t%e.length);function ra(e,t){if(In(e))return e[Math.round((e.length-1)*t)]}const Oe=e=>e!==1?"s":"",qe=e=>e!=null&&e.length?e[0].toUpperCase()+e.substring(1).toLowerCase():"",Yl=e=>{if(!(e!=null&&e.length))return"";switch(e){case"CN":return"Chinese";case"TW":return"Taiwanese";case"KR":return"Korean";default:return"Japanese"}},Af=e=>{if(!(e!=null&&e.length))return"";switch(e){case"CN":return"China";case"TW":return"Taiwan";case"KR":return"South Korea";default:return"Japan"}},wr=e=>{if(!(e!=null&&e.length))return"";switch(e){case"CM":case"ONA":case"OVA":case"PV":case"TV":return e;case"DOUJIN":case"LIGHTNOVEL":case"MANGA":case"MANHUA":case"MANHWA":case"MOVIE":case"MUSIC":case"NOVEL":case"ONE-SHOT":case"SPECIAL":return qe(e);case"ONE_SHOT":return"One-shot";case"TV_SHORT":return"TV short";case"TV_SPECIAL":return"TV special";default:return console.error("Unknown media format"),e}};function Tf(e,t){switch(e){case"COMPLETED":case"DROPPED":case"PAUSED":case"PLANNING":return qe(e);case"CURRENT":return t==="anime"?"Watching":"Reading";case"REPEATING":return t==="anime"?"Rewatching":"Rereading";default:return console.error("Unknown status"),e}}const ye=e=>{if(e!=null)return Intl.NumberFormat("ja-JP").format(e)},js=e=>{if(e!=null)return F(typeof e=="number","Number is not typeof number"),Intl.NumberFormat("en-US",{notation:"compact",maximumFractionDigits:1}).format(e)},Ke=e=>(F(e!=null,"No title given"),encodeURI(e.toLowerCase().replace(/[#%?]+/g,"").replace(/[/\\\-\u2010-\u2015_{}[\]]+/g," ").trim().replace(/ +/g,"-"))),Ge=e=>(F(e.type,"type is missing"),F("id"in e,"id is missing"),"/ani/"+e.type.toLowerCase()+"/"+e.id+"/"+Ke(e.title.userPreferred)),Wa=e=>{if(F("year"in e,"No year found"),F("month"in e,"No month found"),F("day"in e,"No day found"),!e.year&&!e.month&&!e.day)return"";if(e.year&&!e.month&&!e.day)return e.year.toString();const t={};return e.year&&(t.year="numeric"),e.month&&(t.month="short"),e.day&&(t.day="numeric"),new Date(e.year||1970,e.month-1||0,e.day||1).toLocaleDateString("us-US",t)},sd=e=>{const t=new Date(e),n={year:"numeric",month:"short",day:"numeric"};return t.toLocaleDateString("us-US",n)};function _a(e,t){t&&e(Ge(t))}const zs=e=>typeof e=="object"&&e,If=(e,...t)=>{Nl(t.length<1,"Give more objects");for(const n of t)od(e,n);return e},od=(e,t)=>{for(const n in t)e[n]??(e[n]=t[n]),zs(e[n])&&zs(t[n])?od(e[n],t[n]):e[n]=t[n]},Ef=e=>typeof e=="function",cd=e=>Ef(e)?e():e,Lf=(e,t)=>{dn(e);const n=[];for(const r of t){const i=cd(r);if(i===void 0)return;n.push(i)}return e(...n)},Pe=(e,...t)=>N(()=>Lf(e,t)),Pf=[li,qh,Kh,Jh,wc],Cn=e=>N(()=>{for(const t of Pf)if(cd(e[t]))return t});class Mf{constructor(t={}){this.expiresInSeconds=t.expiresInSeconds,this.fetchOnDebug=t.fetchOnDebug||!1,this.storeName=t.storeName||"",this.type=t.type||"default",this.saveToSessionStorage=t.saveToSessionStorage,F(typeof t=="object","Settings must be object"),F(!t.active||typeof t.active=="function","settings.active should a signal"),F(t.type==="no-store"||Number.isInteger(t.expiresInSeconds),"Give explicit expiration time. 0 if the data never expires"),F(t.type==="no-store"||t.expiresInSeconds>0,"Expiration time should be more than 0"),F(t.type!=="no-store"||!t.storeName,"StoreName is not used because cache type is no-store"),F(!t.saveToSessionStorage||typeof t.saveToSessionStorage=="function","saveToSessionStorage is not function")}}class jl{constructor(t,n,r){F(t,"URL is missing"),this.url=t,this.options=n,this.formatResponse=r,this.settings=new Mf({storeName:"results",type:"fetch-once",expiresInSeconds:60*60*24*365})}get cacheKey(){var t;return`${this.url}${((t=JSON.stringify(this.options))==null?void 0:t.replaceAll('"',""))||""}${this.formatResponse||""}`}}const di=(e,t)=>(e&&(e.settings.type=t),e),Df=(e,t)=>(Xf(e.url),Rf(e,t).finally(()=>Zf(e.url))),Rf=(e,t)=>{const n={...e.options||{},signal:t};if(n.body&&(n.body=JSON.stringify(e.options.body)),n.cache??(n.cache="default"),Math.random()>1)switch(console.log("Error route"),Math.ceil(Math.random()*3)){case 1:return fetch("https://http.codes/429",n);case 2:return fetch("https://http.codes/500",n);case 3:return fetch("https://http.codes/cors",n)}else return e.delay?new Promise((r,i)=>{fetch(e.url,n).then(l=>setTimeout(()=>r(l),e.delay)).catch(i)}):fetch(e.url,n)},ba={},ya={};let Pi=0;const Nf=async(e,t)=>{var i,l,s;try{const{resolve:o,promise:c}=Promise.withResolvers();for(let u=0;u<3&&!t.aborted;u++){Jf(e.url)&&(ka(e.url,o),await c);try{var n=await(ba[i=e.cacheKey]??(ba[i]=Df(e,t)))}catch{if(t.aborted)return null}finally{delete ba[e.cacheKey]}const h=qf(e.url,(n==null?void 0:n.status)||"cors");if((n==null?void 0:n.status)===429&&n.headers.get("Retry-After")){ka(e.url,o);const f=parseInt(n.headers.get("Retry-After"));await new Promise(g=>setTimeout(g,f*1e3));continue}else if((n==null?void 0:n.status)===400&&Pi<3){if(ka(e.url,o),(await n.json()).errors.some(g=>g.message==="Invalid token")){Pi++,await new Promise(g=>setTimeout(g,3e3));continue}}else if(h){ka(e.url,o),await new Promise(f=>setTimeout(f,h));continue}else if(!(n!=null&&n.ok))return null;e.url.includes(jn)&&(Pi=0);try{var r=await(ya[l=e.cacheKey]??(ya[l]=n.json()))}catch(f){return console.error(f),null}finally{delete ya[e.cacheKey]}return((s=e.formatResponse)==null?void 0:s.call(e,r))||r}}catch{}finally{Kf(e.url)}return null},ua=(e,t,n=1)=>{const r=[];let i=null,l=!1;async function s(...c){r.push(async()=>{r.shift(),l=!0,await e(...c),l=!1,o(t)}),r.length==n+1&&r.shift(),!l&&(i===null?o():o(t))}return s.bufferSize=()=>r.length,s;function o(c){const u=r[0];clearTimeout(i),i=null,u&&(c?i=setTimeout(u,c):(l=!0,u()))}},dd=e=>{let t;const n=(r,...i)=>{clearTimeout(t),setTimeout(()=>e(...i),r)};return Ye(()=>clearTimeout(t)),n},Of=e=>{const t=new Date;return t.setMilliseconds(t.getMilliseconds()+e),t},Ff=e=>Of(e*1e3),aa=e=>{if(e!=null)return Intl.NumberFormat("ja-JP").format(e)},Uf=e=>!isNaN(e)&&typeof e=="number",Bf=(e,t)=>{const n=Number(e);return Uf(n)?n:t},Vf=(e,t)=>Math.max(e??t,t??e),wa=(e,t,n)=>e+n*(t-e),Ws=e=>e!=null&&e.length?e[0].toUpperCase()+e.substring(1).toLowerCase():"",Gf=e=>{if(!(e!=null&&e.length))return"";switch(e){case Zh:case Ms:return Ms;case Cc:return"Not yet released";case Qh:case eg:return"Releasing";case tg:return"Cancelled";case ng:return"On hiatus";default:return console.error("Unknown media format"),e}},ud=(e,t)=>"/mal/"+e+"/"+t.mal_id+"/"+Gn(t.title),Hf=e=>"/mal/character/"+e.mal_id+"/"+Gn(e.name),hd=e=>{xt(e.type,"Media type"),xc(e.id,"Media id");const t="/ani/"+e.type.toLowerCase()+"/"+e.id;return e.title.userPreferred?t+"/"+Gn(e.title.userPreferred):t},Yf=()=>location.hostname==="kassu11.github.io"?24951:location.port==5173?7936:location.port==5174?31649:-1,Gn=e=>(xt(e,"title"),encodeURI(e.toLowerCase().replace(/[#%?]+/g,"").replace(/[/\\\-\u2010-\u2015_{}[\]]+/g," ").trim().replace(/ +/g,"-"))),jf=e=>e!==1?"s":"",kr=e=>e!=null&&e.length?e[0].toUpperCase()+e.substring(1).toLowerCase():"",zf=e=>{if(!(e!=null&&e.length))return"";switch(e){case"CN":return"Chinese";case"TW":return"Taiwanese";case"KR":return"Korean";default:return"Japanese"}},Wf=e=>{if(!(e!=null&&e.length))return"";switch(e){case"ANIME":case"COMIC":case"DOUJINSHI":case"GAME":case"MANGA":case"NOVEL":case"ORIGINAL":case"OTHER":return kr(e);case"LIGHT_NOVEL":case"LIVE_ACTION":case"MULTIMEDIA_PROJECT":case"PICTURE_BOOK":case"VISUAL_NOVEL":case"VIDEO_GAME":case"WEB_NOVEL":return kr(e.replace("_"," "));default:return console.error("Unknown media format"),e}},ul=e=>{if(!(e!=null&&e.length))return"";switch(e){case"CM":case"ONA":case"OVA":case"PV":case"TV":return e;case"DOUJIN":case"LIGHTNOVEL":case"MANGA":case"MANHUA":case"MANHWA":case"MOVIE":case"MUSIC":case"NOVEL":case"ONE-SHOT":case"SPECIAL":return kr(e);case"ONE_SHOT":return"One-shot";case"TV_SHORT":return"TV short";case"TV_SPECIAL":return"TV special";default:return console.error("Unknown media format"),e}},gd=e=>{if(!(e!=null&&e.length))return"";switch(e){case"CANCELLED":case"FINISHED":case"HIATUS":case"NOT_YET_RELEASED":case"RELEASING":return kr(e.replaceAll("_"," "));default:return console.error("Unknown media format"),e}},qf=(e,t)=>{if(e.includes(jn))switch(t){case 429:return 25e3;case 500:return 3e3;case"cors":return 4e4}if(e.includes(Ar))switch(t){case 429:return 1e3}if(e.includes(Wh))switch(t){case 429:return 25e3}},ka=(e,t)=>{e.includes(jn)?gf(t):e.includes(Ar)&&vf(t)},Kf=e=>{e.includes(jn)?ff():e.includes(Ar)&&$f()},Jf=e=>{if(e.includes(jn))return Mt!==null;if(e.includes(Ar))return Dt!==null},Xf=e=>{e.includes(jn)?hf():e.includes(Ar)&&pf()},Zf=e=>{e.includes(jn)?mf():e.includes(Ar)&&_f()};var Qf=p("<li data-k-c7a289e2><button data-k-c7a289e2>Logout"),em=p("<li data-k-c7a289e2>"),tm=p('<img data-k-c7a289e2 alt="Profile avatar">'),nm=p("<li data-k-c7a289e2 class=profile>"),rm=p("<nav data-k-c7a289e2 class=main-navigation><ul data-k-c7a289e2><li data-k-c7a289e2></li><li data-k-c7a289e2></li><li data-k-c7a289e2></li><li data-k-c7a289e2>"),am=p("<main data-k-c7a289e2 id=page-content>"),im=p("<footer data-k-c7a289e2 class=main-footer>"),lm=p("<li data-k-c7a289e2><a data-k-c7a289e2>Login with AniList"),sm=p("<div data-k-c7a289e2 class=dev-branch><p data-k-c7a289e2>Preview: </p><button data-k-c7a289e2>Back to Production");function om(e){const t=`https://anilist.co/api/v2/oauth/authorize?client_id=${Yf()}&response_type=token`,{accessToken:n,authUserData:r,logoutUser:i}=ie();let l=new AbortController;return W(()=>{var o,c;l.abort(),l=new AbortController;const s=(c=(o=r())==null?void 0:o.data)==null?void 0:c.name;window.addEventListener("keydown",u=>{u.target!==document.body||u.shiftKey||u.ctrlKey||u.key==="d"&&u.altKey&&s==="kassu11"&&(u.preventDefault(),location.hostname!="localhost"?window.open(location.href.replace(location.origin,"http://localhost:5173")):location.port==5173?window.open(location.href.replace(5173,5174)):window.open(location.href.replace(location.origin,"https://kassu11.github.io")))},{signal:l.signal})}),[(()=>{var s=rm(),o=s.firstChild,c=o.firstChild,u=c.nextSibling,h=u.nextSibling,f=h.nextSibling;return d(c,a(B,{href:"/",children:"Home"})),d(u,a(B,{href:"/browse/anime",children:"Anime"})),d(h,a(B,{href:"/browse/manga",children:"Manga"})),d(f,a(B,{href:"/browse/media",children:"Search"})),d(o,a(T,{get when(){return n()},get fallback(){return(()=>{var g=lm(),m=g.firstChild;return V(m,"href",t),g})()},get children(){return[(()=>{var g=Qf(),m=g.firstChild;return m.$$click=()=>i(),g})(),a(T,{get when(){return r()},get children(){return[(()=>{var g=em();return d(g,a(B,{href:"/notifications",get children(){return["Notifications (",N(()=>r().data.unreadNotificationCount),")"]}})),g})(),(()=>{var g=nm();return d(g,a(B,{get href(){return"/user/"+r().data.name},get children(){return[N(()=>r().data.name),(()=>{var m=tm();return P(()=>V(m,"src",r().data.avatar.large)),m})()]}})),g})()]}})]}}),null),s})(),a(T,{get when(){return localStorage.getItem(Ps)},children:s=>(()=>{var o=sm(),c=o.firstChild;c.firstChild;var u=c.nextSibling;return d(c,s,null),u.$$click=()=>{localStorage.removeItem(Ps),location.reload()},o})()}),a(zh,{}),(()=>{var s=am();return d(s,()=>e.children),s})(),im()]}_e(["click"]);var cm=p("<p>");const[Mi,dm]=O(dl);setInterval(()=>dm(new Date/1e3),1e3*30);function um(e){const t=e.airingAt<Mi(),n=N(()=>{const i=Math.abs(e.airingAt-Mi());return t?na-i%na:i}),r=N(i=>i===!1&&e.airingAt<Mi()?(e.setAiringEpisode(l=>l+1),!0):i,!1);return[a(T,{get when(){return!t&&r()},children:"aired in"}),(()=>{var i=cm();return d(i,a(T,{get when(){return Math.floor(n()/3600/24)},children:l=>[l,"d "]}),null),d(i,a(T,{get when(){return Math.floor(n()/3600%24)},children:l=>[l,"h "]}),null),d(i,a(T,{get when(){return Math.floor(n()%3600/60)},children:l=>[l,"m "]}),null),i})()]}var hm=p('<button data-k-9c12ef02 class="cp-current-card-hover-info normal">Completed'),gm=p("<button data-k-9c12ef02 class=cp-current-card-hover-info> <span data-k-9c12ef02 class=plus>+"),fm=p("<img data-k-9c12ef02 alt=Cover.>"),mm=p("<div data-k-9c12ef02 class=is-behind-container>"),pm=p("<div data-k-9c12ef02 class=cp-current-card-info><p data-k-9c12ef02>Ep "),vm=p("<p data-k-9c12ef02> episode<! data-k-9c12ef02> behind"),$m=p("<p data-k-9c12ef02> episode<! data-k-9c12ef02> left"),_m=p("<p data-k-9c12ef02> chapter<! data-k-9c12ef02> left"),bm=p('<div data-k-9c12ef02 class=hover data-tooltip-positions="right left middle"><p data-k-9c12ef02 class=line-clamp></p><p data-k-9c12ef02 class=progress-status>Progress: ');function ym(e){if(!(e!=null&&e.episode))return null;if((e==null?void 0:e.airingAt)<dl){const t=Math.abs(e.airingAt-dl);return e.episode+Math.floor(t/na)+1}return e.episode}function wm(e){const{accessToken:t}=ie(),n=ua(async(r,i,l)=>{const s=await oe.anilist.mutateMedia(r,{mediaId:i,progress:l});s.status===200&&(F(s.data.progress,"No progress found"),e.data.progress=s.data.progress,s.data.status==="COMPLETED"?e.mutateCache(o=>(o.data.data.Page.mediaList=o.data.data.Page.mediaList.filter(c=>c.id!==e.data.id),o)):e.mutateCache(o=>o))},250,2);return a(z,{get fallback(){return(()=>{var r=gm(),i=r.firstChild;return r.$$click=l=>{l.preventDefault(),n(t(),e.data.media.id,e.progress()+1),e.setProgress(s=>s+1)},d(r,()=>e.progress,i),r})()},get children(){return a(M,{get when(){return e.data.media.episodes===e.progress()||e.data.media.chapters===e.progress()},get children(){var r=hm();return r.$$click=i=>i.preventDefault(),r}})}})}function km(e){const[t,n]=O(e.data.progress),[r,i]=O(ym(e.data.media.nextAiringEpisode)),l=N(()=>r()>t()+1),s=()=>r()-(t()+1),o=()=>Math.min(s()/10,.45),c=()=>1/(s()-o())*100;return a(B,{get href(){return Ge(e.data.media)},"data-tooltip-trigger":!0,class:"cp-current-card",get children(){return[(()=>{var u=fm();return P(()=>V(u,"src",e.data.media.coverImage.large)),u})(),a(T,{get when(){var u;return(u=e.data.media.nextAiringEpisode)==null?void 0:u.airingAt},get children(){var u=pm(),h=u.firstChild;return h.firstChild,d(h,r,null),d(u,a(um,{get airingAt(){return e.data.media.nextAiringEpisode.airingAt},setAiringEpisode:i}),null),d(u,a(T,{get when(){return l()},get children(){var f=mm();return P(g=>(g=`repeating-linear-gradient(90deg, var(--red-400), var(--red-400) ${c()*(1-o())}%, transparent ${c()*(1-o())}%, transparent ${c()}%)`)!=null?f.style.setProperty("background",g):f.style.removeProperty("background")),f}}),null),u}}),a(wm,{get data(){return e.data},get mutateCache(){return e.mutateCache},progress:t,setProgress:n}),(()=>{var u=bm(),h=u.firstChild,f=h.nextSibling;return f.firstChild,d(u,a(z,{get children(){return[a(M,{get when(){return N(()=>!!r())()&&l()},get children(){var g=vm(),m=g.firstChild,y=m.nextSibling;return y.nextSibling,d(g,()=>r()-(t()+1),m),d(g,()=>r()-(t()+1)>1&&"s",y),g}}),a(M,{get when(){return N(()=>r()==null)()&&e.data.media.episodes-t()>0},get children(){var g=$m(),m=g.firstChild,y=m.nextSibling;return y.nextSibling,d(g,()=>e.data.media.episodes-t(),m),d(g,()=>e.data.media.episodes-t()>1&&"s",y),g}}),a(M,{get when(){return e.data.media.chapters-t()>0},get children(){var g=_m(),m=g.firstChild,y=m.nextSibling;return y.nextSibling,d(g,()=>e.data.media.chapters-t(),m),d(g,()=>e.data.media.chapters-t()>1&&"s",y),g}})]}}),h),d(h,()=>e.data.media.title.userPreferred),d(f,t,null),d(f,a(T,{get when(){return e.data.media.episodes},get children(){return["/",N(()=>e.data.media.episodes)]}}),null),d(f,a(T,{get when(){return e.data.media.chapters},get children(){return["/",N(()=>e.data.media.chapters)]}}),null),u})()]}})}_e(["click"]);var Sm=p('<div data-k-ea0ffbeb class="grid-column-auto-fill current">');function Di(e){return a(T,{get when(){return e.cards.length},get children(){var t=Sm();return d(t,a(H,{get each(){return e.cards},children:n=>a(km,{data:n,get mutateCache(){return e.mutateCache}})})),P(()=>t.classList.toggle("loading",!!e.loading)),t}})}var Cm=p("<button data-k-b9535d1e>Picture mode"),xm=p("<button data-k-b9535d1e>Text mode"),Am=p("<div data-k-b9535d1e class=pg-home-current>");const Ri=0,qs=1;function Tm(e){const{isDeveloper:t}=ie(),[n,{mutateCache:r}]=oe.anilist.wachingAnime(e.userId,e.token),[i,{mutateCache:l}]=oe.anilist.readingManga(e.userId,e.token),s=new Date/1e3,o=f=>{if(f==null)return null;if(f<s){const g=(s-f)%na;return s+(na-g)}return f},c=(f,g)=>{var v,$;const m=o((v=f.media.nextAiringEpisode)==null?void 0:v.airingAt),y=o(($=g.media.nextAiringEpisode)==null?void 0:$.airingAt);return m&&y?m-y:m==y?0:m==null?1:-1},[u,h]=Gl("LOB_CURRENTLY_WATCHING_MODE",Ri);return[a(T,{get when(){return t()},get children(){return[(()=>{var f=Cm();return f.$$click=()=>h(Ri),f})(),(()=>{var f=xm();return f.$$click=()=>h(qs),f})()]}}),(()=>{var f=Am();return d(f,a(T,{get when(){return n()},get children(){return[a(Di,{get cards(){return n().data.data.Page.mediaList.filter(g=>g.media.status!=="FINISHED").toSorted(c)},mutateCache:r,get loading(){return n.loading}}),a(Di,{get cards(){return n().data.data.Page.mediaList.filter(g=>g.media.status==="FINISHED")},mutateCache:r,get loading(){return n.loading}})]}}),null),d(f,a(T,{get when(){return i()},get children(){return a(Di,{get cards(){return i().data.data.Page.mediaList},mutateCache:l,get loading(){return i.loading}})}}),null),P(g=>{var m=u()==Ri,y=u()==qs;return m!==g.e&&f.classList.toggle("picture",g.e=m),y!==g.t&&f.classList.toggle("text",g.t=y),g},{e:void 0,t:void 0}),f})()]}_e(["click"]);const nn=(e,t)=>{let n;const r=()=>clearTimeout(n);return Sr()&&Ye(r),Object.assign((...l)=>{n!==void 0&&r(),n=setTimeout(()=>e(...l),t)},{clear:r})};function xn(e,t,n){let r;(function(c){c[c.Ready=0]="Ready",c[c.Leading=1]="Leading",c[c.Trailing=2]="Trailing"})(r||(r={}));let i=r.Ready;const l=e(c=>{i===r.Trailing&&t(...c),i=r.Ready},n),s=(...c)=>{i!==r.Trailing&&(i===r.Ready&&t(...c),i+=1),l(c)},o=()=>{i=r.Ready,l.clear()};return Sr()&&Ye(o),Object.assign(s,{clear:o})}var Im=p("<span>");function Hn(e){const[t,n]=ai(e,["class"]);return(()=>{var r=Im();return Et(r,Fe({get class(){return"cp-loader-circle "+t.class||""}},n),!1,!1),r})()}var Em=p("<tool-tip inert role=tooltip>",!0,!1,!1);function Ct(e){return(()=>{var t=Em();return Et(t,e,!1,!1),t._$owner=Sr(),P(()=>V(t,"tip-position",e.tipPosition)),t})()}function zl(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}let Wn=zl();function fd(e){Wn=e}const qr={exec:()=>null};function Ee(e,t=""){let n=typeof e=="string"?e:e.source;const r={replace:(i,l)=>{let s=typeof l=="string"?l:l.source;return s=s.replace($t.caret,"$1"),n=n.replace(i,s),r},getRegex:()=>new RegExp(n,t)};return r}const $t={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i")},Lm=/^(?:[ \t]*(?:\n|$))+/,Pm=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Mm=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,ha=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Dm=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Wl=/(?:[*+-]|\d{1,9}[.)])/,md=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,pd=Ee(md).replace(/bull/g,Wl).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Rm=Ee(md).replace(/bull/g,Wl).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),ql=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Nm=/^[^\n]+/,Kl=/(?!\s*\])(?:\\.|[^\[\]\\])+/,Om=Ee(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Kl).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Fm=Ee(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Wl).getRegex(),ui="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Jl=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Um=Ee("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Jl).replace("tag",ui).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),vd=Ee(ql).replace("hr",ha).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ui).getRegex(),Bm=Ee(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",vd).getRegex(),Xl={blockquote:Bm,code:Pm,def:Om,fences:Mm,heading:Dm,hr:ha,html:Um,lheading:pd,list:Fm,newline:Lm,paragraph:vd,table:qr,text:Nm},Ks=Ee("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",ha).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ui).getRegex(),Vm={...Xl,lheading:Rm,table:Ks,paragraph:Ee(ql).replace("hr",ha).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Ks).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ui).getRegex()},Gm={...Xl,html:Ee(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Jl).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:qr,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:Ee(ql).replace("hr",ha).replace("heading",` *#{1,6} *[^
]`).replace("lheading",pd).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Hm=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Ym=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,$d=/^( {2,}|\\)\n(?!\s*$)/,jm=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,hi=/[\p{P}\p{S}]/u,Zl=/[\s\p{P}\p{S}]/u,_d=/[^\s\p{P}\p{S}]/u,zm=Ee(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Zl).getRegex(),bd=/(?!~)[\p{P}\p{S}]/u,Wm=/(?!~)[\s\p{P}\p{S}]/u,qm=/(?:[^\s\p{P}\p{S}]|~)/u,Km=/\[[^[\]]*?\]\((?:\\.|[^\\\(\)]|\((?:\\.|[^\\\(\)])*\))*\)|`[^`]*?`|<[^<>]*?>/g,yd=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,Jm=Ee(yd,"u").replace(/punct/g,hi).getRegex(),Xm=Ee(yd,"u").replace(/punct/g,bd).getRegex(),wd="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",Zm=Ee(wd,"gu").replace(/notPunctSpace/g,_d).replace(/punctSpace/g,Zl).replace(/punct/g,hi).getRegex(),Qm=Ee(wd,"gu").replace(/notPunctSpace/g,qm).replace(/punctSpace/g,Wm).replace(/punct/g,bd).getRegex(),ep=Ee("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,_d).replace(/punctSpace/g,Zl).replace(/punct/g,hi).getRegex(),tp=Ee(/\\(punct)/,"gu").replace(/punct/g,hi).getRegex(),np=Ee(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),rp=Ee(Jl).replace("(?:-->|$)","-->").getRegex(),ap=Ee("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",rp).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),qa=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,ip=Ee(/^!?\[(label)\]\(\s*(href)(?:\s+(title))?\s*\)/).replace("label",qa).replace("href",/<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),kd=Ee(/^!?\[(label)\]\[(ref)\]/).replace("label",qa).replace("ref",Kl).getRegex(),Sd=Ee(/^!?\[(ref)\](?:\[\])?/).replace("ref",Kl).getRegex(),lp=Ee("reflink|nolink(?!\\()","g").replace("reflink",kd).replace("nolink",Sd).getRegex(),Ql={_backpedal:qr,anyPunctuation:tp,autolink:np,blockSkip:Km,br:$d,code:Ym,del:qr,emStrongLDelim:Jm,emStrongRDelimAst:Zm,emStrongRDelimUnd:ep,escape:Hm,link:ip,nolink:Sd,punctuation:zm,reflink:kd,reflinkSearch:lp,tag:ap,text:jm,url:qr},sp={...Ql,link:Ee(/^!?\[(label)\]\((.*?)\)/).replace("label",qa).getRegex(),reflink:Ee(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",qa).getRegex()},hl={...Ql,emStrongRDelimAst:Qm,emStrongLDelim:Xm,url:Ee(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,"i").replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\.|[^\\])*?(?:\\.|[^\s~\\]))\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},op={...hl,br:Ee($d).replace("{2,}","*").getRegex(),text:Ee(hl.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Sa={normal:Xl,gfm:Vm,pedantic:Gm},Dr={normal:Ql,gfm:hl,breaks:op,pedantic:sp},cp={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Js=e=>cp[e];function tn(e,t){if(t){if($t.escapeTest.test(e))return e.replace($t.escapeReplace,Js)}else if($t.escapeTestNoEncode.test(e))return e.replace($t.escapeReplaceNoEncode,Js);return e}function Xs(e){try{e=encodeURI(e).replace($t.percentDecode,"%")}catch{return null}return e}function Zs(e,t){var l;const n=e.replace($t.findPipe,(s,o,c)=>{let u=!1,h=o;for(;--h>=0&&c[h]==="\\";)u=!u;return u?"|":" |"}),r=n.split($t.splitPipe);let i=0;if(r[0].trim()||r.shift(),r.length>0&&!((l=r.at(-1))!=null&&l.trim())&&r.pop(),t)if(r.length>t)r.splice(t);else for(;r.length<t;)r.push("");for(;i<r.length;i++)r[i]=r[i].trim().replace($t.slashPipe,"|");return r}function Rr(e,t,n){const r=e.length;if(r===0)return"";let i=0;for(;i<r&&e.charAt(r-i-1)===t;)i++;return e.slice(0,r-i)}function dp(e,t){if(e.indexOf(t[1])===-1)return-1;let n=0;for(let r=0;r<e.length;r++)if(e[r]==="\\")r++;else if(e[r]===t[0])n++;else if(e[r]===t[1]&&(n--,n<0))return r;return-1}function Qs(e,t,n,r,i){const l=t.href,s=t.title||null,o=e[1].replace(i.other.outputLinkReplace,"$1");if(e[0].charAt(0)!=="!"){r.state.inLink=!0;const c={type:"link",raw:n,href:l,title:s,text:o,tokens:r.inlineTokens(o)};return r.state.inLink=!1,c}return{type:"image",raw:n,href:l,title:s,text:o}}function up(e,t,n){const r=e.match(n.other.indentCodeCompensation);if(r===null)return t;const i=r[1];return t.split(`
...
`)}}}fences(t){const n=this.rules.block.fences.exec(t);if(n){const r=n[0],i=up(r,n[3]||"",this.rules);return{type:"code",raw:r,lang:n[2]?n[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):n[2],text:i}}}heading(t){const n=this.rules.block.heading.exec(t);if(n){let r=n[2].trim();if(this.rules.other.endingHash.test(r)){const i=Rr(r,"#");(this.options.pedantic||!i||this.rules.other.endingSpaceChar.test(i))&&(r=i.trim())}return{type:"heading",raw:n[0],depth:n[1].length,text:r,tokens:this.lexer.inline(r)}}}hr(t){const n=this.rules.block.hr.exec(t);if(n)return{type:"hr",raw:Rr(n[0],`
